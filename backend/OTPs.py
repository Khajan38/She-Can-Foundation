...
def send_email(receiver_email, otp):
    ...
    <html>
        <body>
            <h3>Welcome to She Can Foundation 👋</h3>
    ...
    message = Mail(
        ...
        subject="She Can Foundation OTP Verification",
...
def send_sms_otp():
    ...
    otp = generate_otp()
    if send_sms(phone, f"She Can Foundation: Your OTP is {otp}. Do not share this code with anyone. Valid for 1 minute."):
